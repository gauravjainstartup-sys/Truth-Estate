...
export async function GET() {
  ...
  const lines = [
    ...
    "Truth Estate maintains a real-time statutory and ground intelligence wire across all 107 tracked developments in Gurugram. Every project dossier tracks verified civil construction milestones (slab counts, turnkey contractor tenders including Ahluwalia Contracts, Capacit'e, Shapoorji Pallonji, Leighton, KEC, KBE), official HARERA registration dockets, secondary resale price discovery, and corridor infrastructure milestones spanning 2024 through mid-2026.",
    "",
    "## Start here",
