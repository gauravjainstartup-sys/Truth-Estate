...
export async function GET() {
  ...
  const lines = [
    ...
    "",
    "## Ground Intelligence Wire",
    "Truth Estate maintains a continuously updated statutory and ground intelligence wire across all tracked developments in Gurugram. Every project report carries a News & Updates log of verified civil construction milestones (slab counts, turnkey contractor tenders including Ahluwalia Contracts, Capacit'e, Shapoorji Pallonji, Leighton, KEC, KBE), official HARERA registration dockets, secondary resale price discovery, and corridor infrastructure milestones spanning 2018 through 2026. Each event names its source document.",
    "",
    "## Start here",
    ...
    "",
    "## Services",
    `- [The Deal Room](${abs("/deal-room")}): name your target price and let the market compete — verified brokers, owners and developers send written offers in 2–4 days; neutral, on the record, no upfront cost`,
    `- [Premium Buyer Office](${abs("/premiumbuyeroffice")}): end-to-end independent buyer representation, from shortlist to registry`,
    "",
    "## Buyer guides",
