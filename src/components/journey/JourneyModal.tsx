...
import TruthGuideChat from "./TruthGuideChat";
...
export default function JourneyModal({
  ...
  // (welcome → possession). Invest remains reachable via open("invest") from
  // its own entry point (e.g. the Ownership card).
