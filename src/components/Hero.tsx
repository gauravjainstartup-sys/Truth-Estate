    ...
    <section className="teh2 relative w-full overflow-hidden bg-[#14110d]" style={{ height: "100svh", maxHeight: "900px", minHeight: "560px" }}>
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-7xl items-start px-6 pt-28 pb-16 md:items-center md:px-10 md:pt-7 md:pb-7 lg:px-16">
        <div className="w-full max-w-[380px] md:max-w-[46%] md:-translate-y-12">
          ...
          {/* TruthGuide — anchored into the hero's empty band under the
             requirements whisper on DESKTOP (the floating bubble hides its
             desktop pill on home so there's exactly one entry). Mobile keeps
             the corner FAB; this stays hidden there. Same pill, same brand. */}
          <button
            type="button"
            onClick={() => open("research")}
            aria-label="Ask TruthGuide"
            className="group mt-5 hidden items-center gap-3 rounded-full border border-[#c9a96e]/30 bg-[#0a0a0a]/70 py-2.5 pl-2.5 pr-5 text-left text-white backdrop-blur transition-all duration-300 hover:border-[#c9a96e]/60 md:flex"
          >
