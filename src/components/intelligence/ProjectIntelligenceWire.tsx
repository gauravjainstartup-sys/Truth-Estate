        ...
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-center">
          <div className="max-w-xl">
            ...
            <p className="mt-2 text-[0.82rem] leading-relaxed text-[#f6f1e8]/65">
              Leave a number or email and an advisor puts {projectName} on the watch — a personal WhatsApp / email heads-up when a verified ground event lands: a new filing, RERA slippage, a corridor change. Concierge, by hand. Zero broker spam. Ever.
            </p>
          </div>
            ...
            {subscribed ? (
              ...
              <form
                onSubmit={(e) => {
                  ...
                  /* Capture the lead for a manual/concierge alert — an advisor
                     watches the project and reaches out by hand. Recorded like
                     every other enquiry (contact_lead, intent "wire-alert"). */
                  saveLead({
                    name: "",
                    email: isEmail ? v : "",
                    phone: isEmail ? "" : v,
