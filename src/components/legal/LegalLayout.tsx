...
export default function LegalLayout({
  ...
  return (
    <div className="min-h-svh bg-[#F5F0E8] text-[#1a1a1a]">
      ...
      {/* Single grid: TOC alongside hero + content */}
      <div className="mx-auto max-w-7xl px-6 pt-[7vh] md:px-10 md:pt-[9vh]">
        <div className="lg:grid lg:grid-cols-[200px_1fr] lg:gap-14 xl:grid-cols-[220px_1fr] xl:gap-16">
          ...
          {/* Right column: hero + trust note + content */}
          <div>
            ...
            {/* Trust note */}
            <div className="mt-8 max-w-[680px] border-l-2 border-[#c9a96e]/25 py-2 pl-5">
            ...
            {/* Content */}
            <div className="mt-[5vh] max-w-[680px] md:mt-[7vh]">
              {/* Mobile TOC */}
